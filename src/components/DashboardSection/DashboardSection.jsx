...
export default function DashboardSection({randomData, heading}) {
  return (
    <section className="sm:w-1/2 flex flex-col items-center backdrop-brightness-75 backdrop-blur-lg m-4 rounded-md drop-shadow-md border border-best-white rounded-md">
