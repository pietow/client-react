...
export default function ChatBox({ accessToken, resize, setResize }) {
    const style =
        accessToken && resize
        ...
        <>
            ...
            <div className={style}>
                ...
                <div className="flex items-center gap-2">
                    ...
                    />
                    <button
                        /* onClick={messageToHost()} */ className="active:scale-95 p-1 border border-best-white text-best-white rounded">
                        Reply
                    </button>
                </div>
