...
export default function LgNavList() {
  ...
  return (
    <ul className="flex">
        ...
        <li className="px-4 pb-2 pt-1 hover:scale-110"><Link onClick={() => {setAccessToken(''); sessionStorage.removeItem('key'); alert('logout successful.')}} to="/">logout</Link></li> {/* put a func here to delete accessToken from state as well as sessionStorage */}
    </ul>
